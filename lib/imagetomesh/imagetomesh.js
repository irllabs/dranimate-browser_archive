...
/* Public stuff */
    ...
    this.eraseUnselectedPixels = function () {
        ...
        context.drawImage(
            ...
            canvas.width, canvas.height);
        context.drawImage(
            imageBackgroundMaskImage, 
            0, 0, 
            imageBackgroundMaskImage.width, imageBackgroundMaskImage.height,
            0, 0, 
            canvas.width, canvas.height);*/
...
/* Private stuff */
    ...
    var imageBackgroundMaskImage = new Image();
